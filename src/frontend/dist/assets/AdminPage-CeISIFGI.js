import { c as createLucideIcon, z as React, r as reactExports, R as ReactDOM, j as jsxRuntimeExports, B as React$1, D as reactDomExports, l as cn, s as useAdminStore, a as useActor, h as useQueryClient, b as useQuery, q as ShieldCheck, d as createActor } from "./index-BiC3Bukn.js";
import { u as useMutation } from "./useMutation-BlzaivA3.js";
import { c as composeRefs, u as useComposedRefs, b as buttonVariants, B as Button, C as Clock } from "./button-BnI6w-mQ.js";
...
function AdminNav({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "data-ocid": "admin-nav",
      children: ADMIN_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => onTabChange(tab),
          className: `relative px-4 py-2.5 rounded-lg text-sm font-medium transition-smooth ${active === tab ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`,
          "data-ocid": `admin-nav-${tab.toLowerCase()}`,
          children: [
            tab,
            tab === "Subscriptions" && pendingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 bg-amber-500 text-background text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center", children: pendingCount > 9 ? "9+" : pendingCount })
          ]
        },
        tab
      ))
...
function AdminPage({ onTabChange }) {
  ...
  const resetMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      ue.success("Overview stats have been reset successfully");
      setResetOpen(false);
    },
    onError: (err) => {
      const msg = err instanceof Error ? err.message : "Failed to reset overview stats.";
      ue.error(msg);
      setResetOpen(false);
    }
  });
  if (!isAdminAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[70vh] text-center px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-16 h-16 text-primary mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black text-2xl text-foreground mb-3", children: "Admin Access Required" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
        "Click the ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "shield icon" }),
        " in the header and enter your admin password."
      ] })
    ] });
  }
  const pendingCount = (pendingApprovals == null ? void 0 : pendingApprovals.length) ?? 0;
  const totalUsers = analytics ? Number(analytics.totalUsers) : null;
  const activeSubscribers = analytics ? Number(analytics.proSubscribers) + Number(analytics.premiumSubscribers) : null;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl font-bold text-foreground mb-1", children: "Admin Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Welcome back, Admin. Here's what's happening on Zyro TV." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { open: resetOpen, onOpenChange: setResetOpen, children: [
              ...
              AlertDialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogTitle, { className: "flex items-center gap-2 font-display text-foreground", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { className: "text-muted-foreground", children: [
                      "This will clear",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "all view counts, likes, and watch history" }),
                      " ",
                      "across the entire platform. User accounts and subscription tiers will not be affected.",
                      " ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      AlertDialogAction,
                      {
                        ...
                        children: resetMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-destructive-foreground/30 border-t-destructive-foreground rounded-full animate-spin" }),
                          "Resetting…"
        ...
        pendingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-amber-500/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-amber-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-amber-400", children: [
                  pendingCount,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Click to review and approve or reject" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-amber-400 shrink-0" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  analyticsLoading && s.label !== "Pending Subs" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-20 mb-1" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-24 mb-1" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-16" })
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-black text-foreground mb-0.5", children: s.value !== null ? s.value.toLocaleString() : "0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: s.label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-0.5", children: s.sub })
                  ] })
                ]
              },
              s.label
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-6", "data-ocid": "quick-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground mb-4", children: "Quick Actions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: quickActions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex items-center justify-between p-4 rounded-xl transition-smooth group w-full text-left ${action.urgent ? "bg-amber-500/10 hover:bg-amber-500/15 border border-amber-500/20" : "bg-muted/20 hover:bg-muted/40"}`,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `w-9 h-9 rounded-lg flex items-center justify-center ${action.urgent ? "bg-amber-500/20" : "bg-muted/60"}`,
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          action.icon,
                          {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    action.count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-xs font-bold px-2 py-0.5 rounded-full ${action.urgent ? "bg-amber-500/20 text-amber-400" : "bg-primary/20 text-primary"}`,
                        children: action.count
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-muted-foreground group-hover:text-foreground transition-smooth" })
                  ] })
                ]
              },
              action.label
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-6", "data-ocid": "recent-activity", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground mb-4", children: "Recent Activity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-10 h-10 text-muted-foreground/30 mb-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No recent activity" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-1", children: "Activity will appear here as users interact with the platform." })
                ]
              }
            )
          ] })
