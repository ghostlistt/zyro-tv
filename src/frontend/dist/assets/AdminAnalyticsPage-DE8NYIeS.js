import { c as createLucideIcon, w as commonjsGlobal, x as getDefaultExportFromCjs, r as reactExports, y as clsx, z as React, A as invariant, s as useAdminStore, a as useActor, h as useQueryClient, b as useQuery, j as jsxRuntimeExports, d as createActor } from "./index-BiC3Bukn.js";
import { u as useMutation } from "./useMutation-BlzaivA3.js";
import { A as AdminNav, a as AlertDialog, b as AlertDialogTrigger, R as RotateCcw, c as AlertDialogContent, d as AlertDialogHeader, e as AlertDialogTitle, T as TriangleAlert, f as AlertDialogDescription, g as AlertDialogFooter, h as AlertDialogCancel, i as AlertDialogAction, U as Users, D as DollarSign, S as Skeleton, u as ue } from "./AdminPage-CeISIFGI.js";
import { B as Button } from "./button-BnI6w-mQ.js";
    ...
    "div",
    {
      ...
      children: [
        ...
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-black text-foreground mb-0.5", children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-0.5", children: sub })
        ] })
      ]
    }
  );
...
function AdminAnalyticsPage({
  ...
  const resetMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      ue.success("Analytics have been reset successfully");
      setResetOpen(false);
    },
    onError: (err) => {
      const msg = err instanceof Error ? err.message : "Failed to reset analytics. Please try again.";
      ue.error(msg);
      setResetOpen(false);
    }
  });
  ...
  const subscriberGrowth = analytics ? [
    {
      month: "Now",
      subscribers: Number(analytics.freeSubscribers) + Number(analytics.proSubscribers) + Number(analytics.premiumSubscribers)
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AdminNav, { active: "Analytics", onTabChange }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground mb-1", children: "Platform Analytics" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Live data from backend" })
          ] }),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { className: "text-muted-foreground", children: [
                      ...
                      " ",
                      "across the entire platform. Subscriber counts will not be affected.",
                      " ",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                MetricCard,
                {
                  icon: Film,
                  label: "Total Shows",
                  value: analytics ? Number(analytics.totalShows).toLocaleString() : "0",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                MetricCard,
                {
                  ...
                  value: analytics ? Number(analytics.totalEpisodes).toLocaleString() : "0",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid lg:grid-cols-2 gap-6 mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "glass-card rounded-xl p-6",
            "data-ocid": "chart-subscribers",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-bold text-foreground mb-1", children: "Active Subscribers (Current)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-6", children: "Total paid + free users on the platform right now" }),
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-[240px] rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                LineChart,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      YAxis,
                      {
                        ...
                        axisLine: false,
                        tickLine: false,
                        tickFormatter: (v2) => v2 >= 1e3 ? `${(v2 / 1e3).toFixed(0)}K` : v2.toString()
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Tooltip,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-bold text-foreground mb-6", children: "Subscription Tier Distribution" }),
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-[280px] rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Pie,
                    {
                      ...
                      paddingAngle: 4,
                      dataKey: "value",
                      children: tierDistribution.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, entry.name))
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Legend,
                    {
                      formatter: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9ca3af", fontSize: "12px" }, children: value })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tooltip,
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "w-5 h-5 text-amber-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-bold text-foreground", children: "Platform Summary" })
                ] }),
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["a", "b", "c", "d", "e", "f"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full rounded-lg" }, k2)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 px-2 pb-3 text-xs text-muted-foreground font-semibold uppercase tracking-wider border-b border-border", children: [
                  ...
                  [
                    {
                      label: "Total Users",
                      value: analytics ? Number(analytics.totalUsers).toLocaleString() : "0"
                    },
                    {
                      label: "Total Shows",
                      value: analytics ? Number(analytics.totalShows).toLocaleString() : "0"
                    ...
                    {
                      label: "Free Accounts",
                      value: analytics ? Number(analytics.freeSubscribers).toLocaleString() : "0"
                    },
                    {
                      label: "Paid Subscribers",
                      value: analytics ? (Number(analytics.proSubscribers) + Number(analytics.premiumSubscribers)).toLocaleString() : "0"
                    }
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right text-sm font-mono font-bold text-foreground", children: row.value })
                      ]
                    },
                    row.label
                  ))
